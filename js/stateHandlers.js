...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'AMAZON.HelpIntent' : function () {
            var message = 'Welcome to the Bulk dot com Podcast. You can say, play the audio, to begin the podcast.';
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to the Bulk dot com Podcast. You can say, play the audio to begin the podcast.';
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'You are listening to the bulk dot com Podcast. You can say, Next or Previous to navigate through the playlist. ' +
